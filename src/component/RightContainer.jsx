...
export default function RightContainer() {
  ...
  return (
    <div className="lg:w-[calc(100vw-280px)] pb-10 lg:ml-[280px] bg-slate-100 px-5 py-5">
      ...
      <div className="flex lg:flex-row flex-col justify-evenly items-center w-full lg:mt-6 mt-3">
        <div className="flex justify-around items-center md:w-[260px] w-[300px] py-2 my-2 bg-white rounded-lg">
